...
GRANT ALL ON public.meeting_attendees TO authenticated;
GRANT SELECT ON public.meeting_agenda TO anon, authenticated;
GRANT ALL ON public.meeting_agenda TO authenticated;
GRANT SELECT ON public.meeting_minutes TO anon, authenticated;
GRANT ALL ON public.meeting_minutes TO authenticated;
GRANT SELECT ON public.meeting_action_items TO anon, authenticated;
GRANT ALL ON public.meeting_action_items TO authenticated;
GRANT SELECT ON public.meeting_notifications TO anon, authenticated;
GRANT ALL ON public.meeting_notifications TO authenticated;
...
GRANT SELECT ON public.internal_messages TO anon, authenticated;
...
GRANT SELECT ON public.message_notifications TO anon, authenticated;
...
GRANT SELECT ON public.task_notifications TO anon, authenticated;
GRANT ALL ON public.task_notifications TO authenticated;
GRANT SELECT ON public.task_activities TO anon, authenticated;
GRANT ALL ON public.task_activities TO authenticated;
